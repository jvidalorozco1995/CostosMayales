<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebLineasRetiradasLineaBase.aspx.cs" Inherits="ArchivoCostosWeb.WebLineasRetiradas" %>
...
OnClientClick="JavaScript: window.history.back(1); return false;"></asp:LinkButton>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ArchivoCostosConnectionString %>" OnSelecting="SqlDataSource1_Selecting" SelectCommand="  SELECT        referencia1, referencia2, referencia3, presupuesto, codcapi, capitulo, codunit, unitario, undunita, cantxppto, codinsu, insutipo, insumo, unidinsu, ctrlinven, 
