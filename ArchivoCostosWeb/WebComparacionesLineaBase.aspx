<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebComparacionesLineaBase.aspx.cs" Inherits="WebCostosPresupuestos.WebComparacionesLineaBase" %>
  ...
  padding:0;
    ...
    <script type="text/javascript">
        ...
        /*function toggleByClass() {
            var DivGrilla = document.getElementById('Grilla');
            var DivAcciones = document.getElementById('Acciones');
            var DivGrupos = document.getElementById('Grupos');
            var link = document.getElementById('aShow');
        
            // $("." + className).toggle();
            if (DivAcciones.style.display == "block") {

  

                DivAcciones.style.display = "none";
                DivGrilla.style.display = "block";
        ...
        //        $("input[id$='BtnEjecutar']").click();

        //        $('.Acciones').hide("swing");
        //        $('.Grilla').show("swing");
        //        $('.Grupos').show("swing");
        //        /* $('.Acciones').hide(30000, function () {
        //            $('.Acciones').css("display", "none");
        //        });

        //        $('.Grupos').show(30000, function () {
        //            $('.Grupos').css("display", "block");
        //        });

        //        $('.Grilla').show(30000, function () {
        //            $('.Grilla').css("display", "block");
        //        });*/

        //        $("#Ejecutar").hide("swing");
        //        $("#Ejecutar2").show("swing");
...
<body>
    ...
    <div style="margin-left: auto; margin-right: auto; text-align: center;">
        <asp:Label ID="Label1" runat="server" Text="Comparaciones Semana Actual VS Linea Base"  Font-Size="X-Large" ForeColor="#B70000" Font-Names="Calibri" style="text-align: center; align-content:center;"></asp:Label>
      </div> 
         <%--<a href="javascript:toggleByClass();" id="aShow">Show Text</a>--%>
                       
             <asp:LinkButton Names="Calibri" ForeColor="#B70000" ID="BtnExportarExcel" runat="server" OnClick="BtnExportarExcel_Click" Text="Exportar a Excel" Width="106px" />
             <asp:LinkButton  Names="Calibri" ForeColor="#B70000" ID="BtnLineasAgregadas" runat="server" Text="Lineas Agregadas" Width="132px" OnClick="BtnLineasAgregadas_Click" />
                                ...
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="CargarGrilla" PageSize="1000" AllowSorting="True" Font-Names="Calibri" Font-Size="12pt" Width="500px" OnPageIndexChanged="GridView1_PageIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging" EmptyDataText="No hubo ninguna variación en estas fechas">
                                    <Columns>
                                        <asp:BoundField DataField="origen" HeaderText="origen" ReadOnly="True" SortExpression="origen" >
                                             ...
                                             <HeaderStyle Font-Names="Calibri" Font-Size="12pt" ForeColor="#B70000" /></asp:BoundField>
                                        ...
                                        <HeaderStyle Font-Names="Calibri" Font-Size="12pt" ForeColor="#B70000" /></asp:BoundField>
                                        <asp:BoundField DataField="saldoxunit" HeaderText="Saldoxunit" ReadOnly="True" SortExpression="saldoxunit" >
                                        <HeaderStyle Font-Names="Calibri" Font-Size="12pt" ForeColor="#B70000" /></asp:BoundField>
                                        ...
                                        <HeaderStyle Font-Names="Calibri" Font-Size="12pt" ForeColor="#B70000" /></asp:BoundField>
                                        <asp:BoundField DataField="Vlrini" HeaderText="Vlrini" ReadOnly="True" SortExpression="Vlrini" >
                                        <HeaderStyle Font-Names="Calibri" Font-Size="12pt" ForeColor="#B70000" /></asp:BoundField>
      ...
      <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ArchivoCostosConnectionString %>" SelectCommand="SELECT * FROM [Vistadepruebaporfavoreliminamecuandotermines]"></asp:SqlDataSource>
                    ...
                    <asp:SqlDataSource ID="CargarTextBox" runat="server" ConnectionString="<%$ ConnectionStrings:ArchivoCostosConnectionString %>" SelectCommand="SELECT [Id], [Fecha], [Proyecto], [Tipo] FROM [Fechas] WHERE (([Proyecto] = @Proyecto) AND ([Tipo] = @Tipo))">
                        <SelectParameters>
                            <asp:SessionParameter Name="Proyecto" SessionField="ProyectoInforme" Type="String" />
                            <asp:Parameter DefaultValue="True" Name="Tipo" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>

                       <asp:SqlDataSource ID="CargarProyecto" runat="server" ConnectionString="<%$ ConnectionStrings:ArchivoCostosConnectionString %>" SelectCommand="SELECT [Codigo], [Proyecto], [Filtro] FROM [Proyectos]"></asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ArchivoCostosConnectionString %>" SelectCommand="SELECT [Id], [Fecha], [Proyecto], [Tipo] FROM [Fechas] WHERE ([Tipo] = @Tipo) and Proyecto= @Proyecto order by Fecha DESC">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="False" Name="Tipo" Type="String" />
                            <asp:SessionParameter DefaultValue="" Name="Proyecto" SessionField="ProyectoInforme" />
                        </SelectParameters>
                    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="CargarGrilla" runat="server" ConnectionString="<%$ ConnectionStrings:ArchivoCostosConnectionString %>" SelectCommand="ComparacionesModificacionesGRUPOSLINEABASE" SelectCommandType="StoredProcedure" OnSelecting="CargarGrilla_Selecting">
            <SelectParameters>
                ...
                <asp:SessionParameter Name="Fecha1" SessionField="SemanaActualInforme" Type="Int32" />
                <asp:SessionParameter Name="Fecha2" SessionField="SemanaLineaBaseInforme" Type="Int32" />
