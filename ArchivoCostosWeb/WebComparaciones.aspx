<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebComparaciones.aspx.cs" Inherits="ArchivoCostos.WebComparaciones" %>
...
<body>
    ...
    <asp:SqlDataSource ID="CargarGrilla" runat="server" ConnectionString="<%$ ConnectionStrings:ArchivoCostosConnectionString %>" SelectCommand="ComparacionesModificacionesGRUPOS" SelectCommandType="StoredProcedure" OnSelecting="CargarGrilla_Selecting">
            <SelectParameters>
                ...
                <asp:SessionParameter Name="Fecha2" SessionField="SemanaPasadaInforme" Type="Int32" />
