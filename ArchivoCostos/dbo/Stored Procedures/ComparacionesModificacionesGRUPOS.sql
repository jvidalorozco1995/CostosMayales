...
/*===================================*/
CREATE proc [dbo].[ComparacionesModificacionesGRUPOS]
...
referencia1
	  ...
	  SELECT referencia1
     FROM [dbo].[VistaCostosPptoProgSemanaPasada]  where   insutipo=@Grupo
INTERSECT
SELECT 
referencia1
...
SELECT referencia1
      ...
      ,[Vlrini]
      ,[vlrejec]
	   FROM  [dbo].[VistaCostosPptoProgSemanaPasada]  where  insutipo=@Grupo AND referencia1 in(
...
(SELECT referencia1
      ...
      ,[vlrproy]
      ,[Vlrini] 
      ,[vlrejec] FROM [dbo].[VistaCostosPptoProgSemanaPasada]  where insutipo=@Grupo AND referencia1 in(
...
SELECT referencia1
      ...
      ,[Vlrini]
      ,[vlrejec]
	   FROM  [dbo].[VistaCostosPptoProgSemanaPasada]  where referencia1   in(
...
(SELECT referencia1
      ...
      ,[vlrproy]
      ,[Vlrini] 
      ,[vlrejec] FROM [dbo].[VistaCostosPptoProgSemanaPasada]  where referencia1  in(
