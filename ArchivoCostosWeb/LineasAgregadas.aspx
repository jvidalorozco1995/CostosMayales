<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LineasAgregadas.aspx.cs" Inherits="WebCostosPresupuestos.LineasAgregadas" %>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style1">
                    <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red" Text="LINEAS AGREGADAS"></asp:Label>
                </td>
            ...
            <tr>
                <td class="auto-style1" colspan="2">
                    ...
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Height="118px" Width="441px" DataSourceID="LineasAgregadasSQLDATASOURCE" EmptyDataText="No hay lineasagregadas para mostrar" Font-Names="Calibri" Font-Size="12pt">
                        <Columns>
            ...
            <tr>
                <td class="auto-style4">
                    <asp:SqlDataSource ID="LineasAgregadasSQLDATASOURCE" runat="server" ConnectionString="<%$ ConnectionStrings:ArchivoCostosConnectionString %>" SelectCommand="
         SELECT        referencia1, referencia2, referencia3, presupuesto, codcapi, capitulo, codunit, unitario, undunita, cantxppto, codinsu, insutipo, insumo, unidinsu, ctrlinven, 
...
WHERE        (IdFecha = @SemanaPasada and t2.referencia1 = t1.referencia1))
                " OnSelecting="LineasAgregadasSQLDATASOURCE_Selecting">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="LblActual" Name="SemanaActual" PropertyName="Text" Type="String" />
                            <asp:ControlParameter ControlID="LblPasada" Name="SemanaPasada" PropertyName="Text" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
            </tr>
