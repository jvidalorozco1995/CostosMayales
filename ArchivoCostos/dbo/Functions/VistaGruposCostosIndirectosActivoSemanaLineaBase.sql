...
create function [dbo].[VistaGruposCostosIndirectosActivoSemanaLineaBase]
 ()
 ...
 as
 begin
 IF(select Distinct(1) from CostosPptoProgSemanaLineaBase where Clasificacion=3)>=1
BEGIN
insert into @GruposCostosIndirectos
	...
	FROM            [ArchivoCostos].[dbo].[VistaGruposCostosIndirectosViviendasSemanaLineaBase]
	UNION
	...
	FROM            [ArchivoCostos].[dbo].[VistaConsolidadoCostosIndirectosApartamentosSemanaLineaBASE]
END
